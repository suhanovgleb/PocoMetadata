...
namespace Breeze.PocoMetadata
{
    ...
    public class EntityDescriptor
    {
        ...
        public virtual bool Include(Type type) // OK
        {
            return true;
        }
        ...
        public virtual Type Replace(Type type, IEnumerable<Type> types) // OK
        {
            return type;
        }
        ...
        public virtual string GetAutoGeneratedKeyType(Type type) // OK
        {
            return null;
        }
        ...
        public virtual string GetResourceName(Type type) // OK
        {
        ...
        public virtual bool IsComplexType(Type type) // OK
        {
            return false;
        }
        ...
        public virtual bool IsKeyProperty(Type type, PropertyInfo propertyInfo) // OK
        {
        ...
        public virtual bool IsVersionProperty(Type type, PropertyInfo propertyInfo) // WHAT
        {
        ...
        public virtual Type GetDataPropertyType(Type type, PropertyInfo propertyInfo) // WHAT
        {
        ...
        /// </example>
        public virtual string GetForeignKeyName(Type type, PropertyInfo propertyInfo) // OK
        {
        ...
        public virtual string GetInversePropertyName(Type containingType, string propertyName, Type relatedType) // WHAT
        {
            return null;
        }
        ...
        public virtual MissingKeyHandling GetMissingFKHandling(Type type, PropertyInfo propertyInfo) // WHAT
        {
        ...
        /// <param name="type">Entity type for which metadata is being generated</param>
        /// <returns>MissingKeyHandling.Error; override to change this behavior</returns>
        public virtual MissingKeyHandling GetMissingPKHandling(Type type) // WHAT
        {
            return MissingKeyHandling.Error;
        }
        ...
        public virtual string Pluralize(string s) // OK
        {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        protected virtual string camelCase(string s) // OK
        {
        ...
        public virtual Dictionary<string, object>[] MapValidationAttribute(ValidationAttribute attr, Dictionary<string, object> definition) // WHAT
        {
            return null;
        }
        ...
        public virtual IEnumerable<Dictionary<string, object>> PostProcessValidators(IEnumerable<Dictionary<string, object>> validators, Dictionary<string, object> definition) // WHAT
        {
            return validators;
        }
    }
    ...
    /// </summary>
    public enum MissingKeyHandling // OK
    {
